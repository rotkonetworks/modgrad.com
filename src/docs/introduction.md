...
**modgrad** is a set of composable Rust crates for building general
intelligence, not a framework. You assemble neural runtimes out of primitives
you can actually reason about: Continuous Thought Machines, multi-region brains,
bio-inspired learning, multimodal codecs, and full-residency GPU compute. (The
name is short for *modular gradient*.)
